...
import com.binfile.opener.viewer.reader.pdf.converter.utils.CmdHandlerCodeArea;
...
public class CodeAreaCmdHandlerCodeAreaDefault implements CmdHandlerCodeArea {
    ...
    public CodeAreaCmdHandlerCodeAreaDefault(Context context, CoreCodeArea codeArea) {
...
//        }
    ...
    public static CmdHandlerCodeArea.CodeAreaCommandHandlerFactory createDefaultCodeAreaCommandHandlerFactory(final Context context) {
        return new  CodeAreaCommandHandlerFactory() {
            
            @Override
            public CmdHandlerCodeArea createCommandHandler(CoreCodeArea codeArea) {
                return new CodeAreaCmdHandlerCodeAreaDefault(context, codeArea);
            }
        };
    }
...
//                        keyEvent.consume();
    ...
    public void keyTyped(int keyCode, KeyEvent keyEvent) {
        ...
        CodeAreaCaretDefault caret = (CodeAreaCaretDefault) ((CaretCapable) codeArea).getCaret();
