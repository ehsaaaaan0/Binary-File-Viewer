...
public class SimpleCodeVisibility {
    ...
    public void recomputeCharPositions(SimpleCodeAreasMetric metrics, BasicCodeAreaStructure structure, SimpleCodeAreasDimension dimensions, BasicCodeAreaLayout layout, BasicCodeAreaScrolling scrolling) {
